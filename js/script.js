...
// 	const windowTop = window.pageYOffset + (window.innerHeight * 0.75); // ou (window.innerHeight * 3) / 4)
...
animeScroll(); // Funcão sempre ativada quando o usuario entrar acessando

// Condicional para verificar se ha algum elemento target para animar
if(target.length){
...
$('.nav-bar-toggle').click(function(){
	$('.menu-navegacao').toggleClass("_open");
	$('.icon').toggleClass("_open")
})